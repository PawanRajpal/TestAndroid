...
public abstract class PaintableObject {
    ...
    public void paintRoundedRect(Canvas canvas, float x, float y, float width, float height) {
        ...
        canvas.drawBitmap(GooglePlacesDataSource.icon, x-GooglePlacesDataSource.icon.getWidth(), y, paint);
    }
    ...
    public void paintText(Canvas canvas, float x, float y, String text) {
    	...
    	//System.out.println("rect x value is************************************"+x);
        //System.out.println("rect y value is************************************"+y);
