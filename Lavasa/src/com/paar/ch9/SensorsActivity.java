...
public class SensorsActivity extends Activity implements SensorEventListener, LocationListener {
    ...
    private static Sensor sensorMagOrien = null;
    ...
    public void onStart() {
        ...
        try {
            ...
            sensorMgr.registerListener(this, sensorMagOrien, SensorManager.SENSOR_DELAY_NORMAL);
            ...
            try {
                if (sensorMgr != null) {
                    ...
                    sensorMgr.unregisterListener(this, sensorMagOrien);
                    sensorMgr = null;
                }
                if (locationMgr != null) {
	...
	public void onSensorChanged(SensorEvent evt) {
         ...
         if (evt.sensor.getType() == Sensor.TYPE_ORIENTATION)
		{
        	...
        	headingAngle = evt.values[0];
			pitchAngle = evt.values[1];
			rollAngle = evt.values[2];
...
//			
            ...
            grav[0] = smooth[0];
           // System.out.println("grav[0] value is*****************************************/"+grav[0]);
         
            grav[1] = smooth[1];
           // System.out.println("grav[1] value is*****************************************/"+grav[1]);
...
//       
		...
		//if(direction[1].equalsIgnoreCase("DOWN")){
