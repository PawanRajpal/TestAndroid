...
public class IconMarker extends Marker {
    ...
    public IconMarker(String name, double latitude, double longitude, double altitude, int color, Bitmap bitmap,String address,float rating) {
        super(name, latitude, longitude, altitude, color,address,rating);
        this.bitmap = bitmap;
    }
    ...
    public void drawIcon(Canvas canvas) {
        ...
        if (gpsSymbol==null) 
        	gpsSymbol = new PaintableIcon(bitmap,50,50);
